...
I've tried all three, and given the choice, I will _always_ pick the first one when managing a small team. It can be unpleasant early on, but it's the only way to build a team that's both happy _and_ effective. Always fight to cultivate and enforce shared culture. 
