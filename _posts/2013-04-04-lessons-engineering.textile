...
Here's how we do it. By default, the reviewer is always right, and the author must fix every defect (we ask the reviewers to be tough, but reasonable). If the author has a strong disagreement, they can appeal to a tech lead. The tech lead's decision is final, and cannot be appealed. You can find a different way to do it, but we found this to be a pretty good system.
