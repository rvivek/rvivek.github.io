...
We've all heard the TDD mantra -- write tests first, always keep them green, maximize code coverage. Empirically, I've found that this testing philosophy produced very binary results. You get one of two outcomes:
