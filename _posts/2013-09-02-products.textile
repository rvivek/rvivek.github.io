...
* *As much as possible* -- most of your resources and creative power will be spent on features in this bucket. These are the features that make customers want to buy your product.
* *As little as possible* (or __as much as necessary__) -- you'll do minimum passable amount of work on any feature that ends up in this bucket. These features don't make customers buy your product, but prevent them from buying if they're missing (which means you should do minimum amount of work you can get away with).
