...
Since a good story is so important both for making decisions and explaining them, startups based on ideas that don't lend themselves to good stories tend to fail. I've found that the inverse is also true -- studying storytelling a surprisingly fruitful way to evaluate startup ideas. You can get quite far by just learning the basics.
