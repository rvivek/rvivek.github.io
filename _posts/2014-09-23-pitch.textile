...
Since a good story is so important both for making decisions and explaining them, startups based on ideas that don't lend themselves to good stories tend to fail, which makes studying storytelling a surprisingly effective way to evaluate startup ideas. Storytelling is a huge field, but you can get quite far by learning the basics.
