...
So you need to get to market with a viable product before anyone else does. Emprically, you can't do that by outexecuting existing companies. Even in the unlikely event that most of your competitors are incompetent, just one capable competitor will dramatically reduce your chances of success. So you need to find a trend first, and get started before everyone else does. There are no formulas, but here are a few ways in which people typically do this.

You can learn about changes early because of your job or hobbies. For example, speech recognition researchers probably knew that speech recognition was getting "good enough" a few years before I did, because I only learned about it when working speech recognition products started hitting the market.
