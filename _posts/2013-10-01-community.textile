...
Is your products a piece of backend infrastructure for web applications? Then what are the popular web development tools? Find out. Integrate with them. How easy is it to use your product from Django? AngularJS? PHP? What other products and services do web developers use? Analytics platforms? Monitoring tools? Can your product integrate with those? Write components to make it easy. Document them well. Add a special section for each tool to your site. Make users who are used to other tools feel comfortable.
...
Always be humble, concise, and direct. Don't try to sound impressive. State what your product does and doesn't do and let your users make their own judgement. Short is better than long. Concrete is better than abstract. Avoid adverbs and adjectives -- use nouns and verbs. Review all copy with an eye for prefabricated phrases and marketing speak. Cut ruthlessly. Read ""Politics and the English Language"":https://www.mtholyoke.edu/acad/intrel/orwell46.htm and follow it religiously.
...
If your product solves a real need, your users will promote it at their workplace. Give them the resources to do it successfully! Ask them what information their colleagues need to make an informed decision about your product. Do they need a whitepaper? A more business-oriented presentation? A press clipping to demonstrate that your product is the real deal? Make that information available to them. Put genuine care and thought into helping your users's with their challenges, and they'll surprise you with their efforts to evangelize your product!

h2. Give thanks

Find creative ways to thank your users for taking the time to get involved in the community. When your users write a blog post, do a talk, create a cool project, or submit an important bug report, take the time to show them your gratitude. Send them a t-shirt. Write a hand-written note. Even a quick e-mail can go a long way. Care about your users, and they'll care about you.

h2. Consistently improve the product

One of the most important things you can do to foster community growth is consistent product releases. We release a new version of RethinkDB every six weeks. Find a good release cycle for your product, and get into the groove.

For every product release, include at least one feature that resolves a complaint from existing users, one feature that attracts new users, and one feature you find interesting. Pick one feature from each category, and weave it into the release announcement. Give each release a title, preferably under 80 characters in length. Take the time to announce it. Write a short blog post explaining what goes into the release and why it matters. Put it on Hacker News, Twitter, or other channels where your audience hangs out. Consider having a team member create a short video explaining the release.

Here is an example RethinkDB release that follows this template: ""RethinkDB 1.7: hot backup, atomic set/get, 10x insert performance improvement"":http://rethinkdb.com/blog/1.7-release/.

h2. Measure impact

When the community around your product gets big, you can no longer rely on your intuition. You have to start measuring the impact you're making and use the instruments to guide your decisions. How many people are actively using your product? What's the attrition rate? How engaged are the existing users? How many support messages do you get daily? How many feature requests? Are you closing issues faster than they're accumulating? Which support channels are your users using most frequently? Build the tools to collect the data __before__ your community gets so big that your intuition breaks down. Your findings may surprise you.
...
Don't try to do too much right away. Optimize for consistency and quality of interactions with your users. Pick a few tasks, and do them every day. Give yourself time to make it a part of your process. As soon as doing them becomes a habit, try to improve. Brainstorm with your team and your users -- how can you do better? Don't add more tasks until the existing ones become second nature. Watch "Jiro Dreams of Sushi":http://en.wikipedia.org/wiki/Jiro_Dreams_of_Sushi. It gives a great sense of what it means to do few things and do them well. Apply this philosophy to your work on building a community around your product.

Be consistent, care about your users, and always try to do better.