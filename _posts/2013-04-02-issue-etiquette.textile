...
h4. IE1. Acknowledge beginning of work
...
h4. IE2. Summaryize the state of the union
...
h4. IE4. Notify about completion
...
h4. IE5. Notify about availability

Mention release number, download URL, thank everyone for their work.

h4. IE6. Summaryize the state of the union

Foo bar.

h4. IE7. Summaryize the state of the union

Foo bar.

h4. IE8. Summaryize the state of the union
