...
It would also be really helpful for the new developer to inform the user they're on the issue. Here's an example message from @coffeemug:
...
h3. IE6. Elaborate the next steps

Foo bar.

h3. IE7. Stay in control

Foo bar.

h3. IE8. Give enough information

Foo bar.

h3. IE9. Inform everyone if you slip

Foo bar.

h3. IE10. Inform everyone you're on track

Foo bar.

h3. IE11. Use friendly tone
