...
Sometimes development takes longer than expected, and sometimes the ETA is far enough into the future to make the user anxious. In both cases, it's immensely helpful to give the user periodic feedback. Here is a quick and informative example update on the state of development:
