...
When you're done with issue, it's helpful to give as much information about it as possible. We try to include as many of the following as possible:
...
bq. I've changed the random number generator to use page faults so it can work on keyboardless servers. Commit 23ab45, internal code review 189 by @jdoliner. Will be available in 1.4 in the next few days.
