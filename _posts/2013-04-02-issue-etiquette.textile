...
bq. Hi @xyz, thanks for letting us know about this bug. This is @wmrowan's and @mlucy's domain, I'll ask one of them to look at it. I'll get back to you when we start looking at it -- we should be able to get to it in a day or two.

It includes everything necessary to keep the user from wondering about the state of the issue:
