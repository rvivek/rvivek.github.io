...
Once you start working on the issue, give the user a quick note that you're looking into it. It's nice when the user knows their issue is being worked on, and it's very useful to be able to talk to the person who's actually working on it.
...
Addtionally, from the developer's POV, it's great to know that someone's on an issue already.
