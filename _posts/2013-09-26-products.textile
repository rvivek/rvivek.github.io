...
Building great products is hard, but the difficulty is greatly exacerbated if you have no good model for analyzing products and features. Without a model you're left with a never-ending stream of feature ideas and taking half-informed shots in the dark. Some people can pull this off because they start out with a phenomenal intuition for product design. But most people aren't blessed with this superpower on day one.
...
The most important aspect of product management is that you should categorize features into three buckets: gamechangers, showstoppers, and distractions. When I first started building products, all features looked roughly the same. Over time, I formed the three bucket model and now my mind automatically slots features into one of these buckets.
...
* *A showstopper.* People won't buy your product because you're missing this feature, but adding this feature won't generate demand.
