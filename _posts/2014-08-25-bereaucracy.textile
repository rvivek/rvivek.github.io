...
If you think about bereaucracies as a systems engineer, you'll find a goldmine of interesting questions. How and why do bereaucratic processes come into existence? What distinguishes effective bereaucracies from complacent ones? How can we build effective bereuacracies from scratch? How do we keep effective bereuacracies from becoming complacent? How can we refactor complacent bereaucracies to be effective again?

At seventeen people RethinkDB is still a tiny company, but we've already introduced, evolved, dismantled, and reintroduced quite a few bereaucratic processes. We don't have nearly enough data to extrapolate to the scale and complexity of massive organizations like General Motors, but we did uncover interesting insights.
