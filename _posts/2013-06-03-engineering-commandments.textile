...
Don't abandon _both_ test suites because you don't yet have the organizational support structure to manage long test suites. Even a small test suite that integrates into the development process makes an enormous difference in quality.
