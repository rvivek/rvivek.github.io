...
Fewer tests that are always green _always_ beat more tests that are bitrotted, and unfortunately sooner or later every project is forced to choose between these two options.