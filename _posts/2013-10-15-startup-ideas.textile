...
For all the complexity of technical innovation, the underlying principles are very simple. Dramatic technical change happens when one or more persistent incremental trends cross a threshold to allow for a qualitative change.
