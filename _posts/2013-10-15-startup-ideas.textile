...
Now you're left with a different set of questions. Where does dramatic change come from? How do you recognize it? How do you generate ideas for dramatic improvements? And how do evaluate any given idea?

h2. Dramatic innovation

For all the complexity of technical, political, or social innovation, the underlying principle is very simple. Dramatic improvement occurs when one or more persistent incremental trends cross a threshold and allow for a qualitative change.
