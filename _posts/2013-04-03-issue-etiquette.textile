...
After a few missteps like this, we evolved issue etiquette guidelines so we can be more helpful to people using the tracker. In the process I found the exact same issue etiquette is extremely helpful to me as a project manager, so I decided to write it down. This list of simple Etiquette Guidelines (*EGs*) can go a very long way to keep users happy.
